export function AboutMe() {
    ...
    return (
        <section id="about-me" className="mb-7">
            <h2 className="text-1xl sm:text-2xl font-bold mb-5 text-center">About Me</h2>
            ...
            <div>
                <div
                    className="hidden md:block hover-scale-large float-right ml-10 mb-8 mt-2 w-[200px] h-[200px] rounded-full overflow-hidden"
                    style={{ shapeOutside: 'circle(50% at 50% 50%)', clipPath: 'circle(50% at 50% 50%)' }}>
                    <img src={profileImage} className="w-full h-full object-cover" />
                </div>
                <div className="space-y-4 text-center md:text-justify">
                    <p>I’m Benjamin, a software engineer passionate about crafting clean, modular, and maintainable code. With seven years of experience
                    ...
                    <p>Throughout my career, I’ve worked closely with major global publishers, implementing scalable and reliable backend solutions that power digital
                        ...
                        I have solid experience designing optimized relational and NoSQL databases, using technologies such as PostgresQL and DynamoDB.</p>
