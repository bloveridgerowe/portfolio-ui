    ...
    [
        {
            ...
            description: [
                ...
                Dockerized environment, with a CI/CD pipeline deploying to Railway, where a managed PostgreSQL instance provides data persistence. A growing unit test suite, 
                built with xUnit and Moq, ensures reliability by validating core business logic and maintaining system integrity as new features are added.`,
                ...
                `This demonstration project is still under active development, and continuously being improved with new enhancements. While users can explore, sign up, and place orders, no real payments are processed,
                and no actual products will be shipped. This is purely a showcase of my skills in full-stack development.`
            ],
            frontend: {
        ...
        },
        {
            name: "Portfolio Site",
            icon: BookOpen,
            link: "https://portfolio-ui.up.railway.app",
            description: [
            ...
            frontend: {
                repositoryLink: "https://github.com/bloveridgerowe/portfolio",
