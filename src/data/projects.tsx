...
export const projects: Project[] = [
    {
        ...
        description: [
            ...
            `This demonstration project is a work in progress, and continuously being improved with new enhancements. While users can explore, sign up, and place orders, no real payments are processed,
